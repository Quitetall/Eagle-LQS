//! Codec manifest loader (SPEC/LQS-v1.0.md §7).
//!
...
pub struct CodecManifest {
    /// LQS spec version the manifest targets.
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            ManifestError::UnsupportedVersion(v) => write!(
                f,
                "codec manifest spec_version {v:?} has a major this grader (LQS {}) does not implement",
                crate::SPEC_VERSION
            ),
        }
    }
...
mod tests {
    ...
    fn parses_full() {
        ...
        assert_eq!(m.codec.output_format, OutputFormat::Lqs0);
