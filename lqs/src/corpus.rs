//! Corpus manifest loader + integrity verifier (SPEC/LQS-v1.0.md §8).
//!
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            CorpusError::UnsupportedVersion(v) => write!(
                f,
                "corpus manifest spec_version {v:?} has a major this grader (LQS {}) does not implement",
                crate::SPEC_VERSION
            ),
